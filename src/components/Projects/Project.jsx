...
const Project = ({ project }) => {
    ...
    return (
        <div onClick={() => navigate(`/projects/${project.id}`)} className="card w-full h-auto bg-secondary bg-opacity-70 border border-secondary shadow-lg rounded-lg relative justify-self-stretch">
            ...
            <div onMouseEnter={() => setShow(true)} onMouseLeave={() => setShow(false)} className="card-body h-full flex items-center text-center absolute opacity-0 hover:opacity-100 ">
                ...
                <p className='text-white text-lg text-left font-sans max-h-[120px] overflow-hidden text-ellipsis'>{description}</p>
